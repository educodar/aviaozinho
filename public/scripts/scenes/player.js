...
Player.prototype.isValidPosition = function(gridPosX, gridPosY) {
    var isInBoard = (gridPosX <= this.grid.xAxisSize) && (gridPosY <= this.grid.yAxisSize) && (gridPosX > 0) && (gridPosY > 0);
    var isInteger = gridPosX % 1 === 0 && gridPosY % 1 === 0;
    return isInBoard && isInteger;
};
